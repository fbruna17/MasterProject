...
weather_decoder_params = {
    'input_size': weather_encoder_params['output_size'],
    'hs_1': 32,
    'hs_2': 48,
    'output_size': 12,
    'dropout': dropout
...
train_new_weather = False
if train_new_weather:
...
pred_net = PredNet(encoder=pretrained.encoder, params=pred_params, dropout=0.1, n_univariate_featues=enc_features, weather_pred=weather_pred)
...
training_params = TrainingParameters(epochs=5,
                                     loss_function=F.mse_loss,
                                     optimiser=optimizer)
